				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Coleções<br>de Notebooks</h3>
							</div>
						</div>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Coleções<br>de Acessórios</h3>
							</div>
						</div>
					</div>
					<!-- /shop -->
										...
										<c:forEach items="${produtosRecentes}" var="p">
											...
											<a href="<%=request.getContextPath()%>/viewProduto?id=${p.id}">
												...
												<div class="product-body">
													...
													<h3 class="product-name"><a href="#">${p.descricao}</a></h3>
													<h4 class="product-price">R$ ${p.valor - (p.valor * (p.desconto / 100))}<del
															class="product-old-price"> R$ ${p.valor}</del></h4>
												</div>
