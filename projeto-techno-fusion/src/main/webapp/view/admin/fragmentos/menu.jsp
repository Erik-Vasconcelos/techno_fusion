<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand d-flex align-items-center m-0" href=" https://demos.creative-tim.com/corporate-ui-dashboard/dashboard.html " target="_blank">
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav" id="ul-menu">
        <li class="nav-item">
          <a class="nav-link" href="<%=contexto%>/inicio.jsp">
		...
		<li class="nav-item">
          <a class="nav-link" href="<%=contexto%>/funcionario" id="btnPaginaFuncinarios">
            <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
